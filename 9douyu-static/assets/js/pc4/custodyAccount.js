;(function($){
	...
	* html结构
	...
	$.validation = function(ele,options){
		...
		// 提现金额检验规则（大于100元整数）
		var patternAmountWithdraw = /^[1-9]\d{2,}(\.\d{1,2})?$/;
				...
				$(this).on('blur',function(){//输入框失焦
					if($(this).data('pattern')){
						...
						var inputTextMsg = {
				            ...
				            'password': '请输入6-16字母和数字组合' ,
				            'passwordOld': '请输入原始密码' ,
				            'passwordTradingOld': '请输入正确的交易密码' ,
				            'passwordSec': '请输入6-16字母和数字组合' ,
				            'checkcode': '请输入校验码' ,
...
// 表单提交验证，可传入三个参数
	$.formSubmitF = function(formEle,options){
		...
		var formTextMsg = {
            ...
            'email': '请输入邮箱地址 ' ,
            'passwordTrading':'请输入交易密码' ,
            'passwordTradingOld': '请输入交易密码' 
