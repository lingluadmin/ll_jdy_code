    ...
    $.extend({
       ...
       getDayRefundBaseInterest: function(yearRate, times, principal) {
        ...
        getEqualPrincipalInterest: function(yearRate, times, principal) {
            ...
            var noEqualCash     = $.getNoEqualRefundCash(principal, monthPercent, times);
            ...
            for(i=0; i<times; i++){
                ...
                if(pcash > -0.05 && i+1==times){
                    list['interest'] = $.toFixed(list['interest'] - pcash);
                }
        ...
        getNoEqualRefundCash: function(cash, monthPercent, timeLimit){
       ...
       //一次性到期还本息
        ...
        getPrincipalInterestListFirstInterest: function(yearRate, times, principal){
            ...
            list['records'][1]  = {
                times: 1,                               //月份
                restBase: $.toFixed(principal),                    //本金余额
                restBaseInterest: $.toFixed(principal),            //本息余额
            ...
            list['records'][2]  = {
                ...
                restBase: 0,                     		//本金余额
                restBaseInterest: 0,                    //本息余额
                timesTotal: $.toFixed(principal),     	//月返本息
                refundBase: $.toFixed(principal),       //月返本金
                interest: 0                     //利息
            }
