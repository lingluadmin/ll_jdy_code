...
function width(el) {
    return  el.length ? el[0].offsetWidth + css(el, 'marginLeft') + css(el, 'marginRight') : true;
};
function height(el) {
    return el.length ? el[0].offsetHeight + css(el, 'marginTop') + css(el, 'marginBottom') : true;
};
