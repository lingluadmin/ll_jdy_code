...
KindEditor.plugin('multiimage', function(K) {
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var phpSession = document.cookie.match(/PHPSESSID=([^;]+)/i);
		if (phpSession) {
			phpSession = phpSession[1];
		}
		...
		var swfupload = K.swfupload({
			...
			uploadUrl : K.addParam(uploadJson, 'dir=image&PHPSESSID='+phpSession),	//Add php session id params
