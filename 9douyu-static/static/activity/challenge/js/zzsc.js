$(function(){
	...
	var movingDistance	    = 298;//每次移动的距离
	var curWidth			= 353;//当前中间li的宽度为353px
	var curHeight         =341;//当前中间li的高度未341  
	var curImgWidth  =331;
	var curImgHeight  =219;
	var othersW           =298;//其他li的宽度
	var othersH           =265;//高度
	var othersImgW           =278;//其他li图片的宽度
	var othersImgH           =184;//高度
	...
	$("#slider .btnnext").click(function(){ change(true);});	
	$("#slider .btnprev").click(function(){ change(false);});
