...
function ImageFlow() {
    ...
    this.defaults =
	{
	    ...
	    opacityArray: [10,  4, 2],   /* Image opacity (range: 0 to 10) first value is for the focussed image */
        ...
        data :{root:[
            {'name':'王秀娟','title':'大街网创始人','quote':'Geek语录：把颠覆做到极致。'},
            {'name':'郭鹏','title':'中国耀盛金融科技事业群总裁','quote':'Geek语录：一生做好一事，始终敬畏风险，始终心存用户。'},
            {'name':'任正非','title':'华为技术有限公司总裁','quote':'Geek语录：企业发展就是要发展一批狼。狼有三大特性：一是敏锐的嗅觉；二是不屈不挠、奋不顾身的进攻精神；三是群体奋斗的意识。'},
            {'name':'刘强东','title':'京东集团首席执行官','quote':'Geek语录：世界虽然残酷，但只要你愿意走，总会有路。'},
            {'name':'姚劲波','title':'58同城首席执行官','quote':'Geek语录：成功比你想象的慢，但规模可能比想象的大。'}
        ]},
        MouseWheel:false
	};
    ...
    this.glideTo = function (imageID)
    {
        ...
        // 介绍文字
        var v = my.imagesDiv.childNodes[imageID].getAttribute('num');
        $("#LoopTitle").text(my.data.root[v].title);
        $("#LoopName").text(my.data.root[v].name);
        $("#LoopQuote").text(my.data.root[v].quote);
