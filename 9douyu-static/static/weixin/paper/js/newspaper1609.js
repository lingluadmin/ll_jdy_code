...
// $('.wrap').css('-webkit-transform','scale('+s+','+s+') translate(0px,-'+ss+'px)');
    ...
    $(document).swipeUp(function(){
        ...
        if(last.row == 13){ now.row = 1; now.col = 1; pageMove(towards.up);}
    ...
    $(document).swipeDown(function(){
        ...
        if(last.row == 1){ now.row = 13; now.col = 1; pageMove(towards.down);}
    })
...
function playbksound() {
    ...
    bg_htm = "<img id='sound_image' src='/static/weixin/paper/images/news1609/play.png' class='img-icon-1 play'>";
    sound_div.innerHTML = bg_htm ;
    document.body.appendChild(sound_div);
}
//播放音频文件
gSound = '/static/weixin/paper/voice/newspaper1609.mp3';
