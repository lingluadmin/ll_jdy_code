...
// $('.wrap').css('-webkit-transform','scale('+s+','+s+') translate(0px,-'+ss+'px)');
    ...
    $(document).swipeUp(function(){
        ...
        if(last.row == 16){ now.row = 1; now.col = 1; pageMove(towards.up);}
    ...
    $(document).swipeDown(function(){
        ...
        if(last.row == 1){ now.row = 16; now.col = 1; pageMove(towards.down);}
    })
...
function playbksound() {
    ...
    bg_htm = "<img id='sound_image' src='/static/weixin/paper/images/news1611/play.png' class='img-icon-1 play'>";
