...
$(document).swipeUp(function(){
	...
	last.row = now.row;
	last.col = now.col;
	if (last.row != 18) { now.row = last.row+1; now.col = 1; pageMove(towards.up);}	
	if(last.row == 18){ now.row = 1; now.col = 1; pageMove(towards.up);}
...
$(document).swipeDown(function(){
	...
	if(last.row == 1){ now.row = 18; now.col = 1; pageMove(towards.down);}
})
    ...
    return document.getElementById(name);
        ...
        function switchsound() {
            ...
            if (au.paused) {
                ...
                ai.className = 'img-icon play';
            }
            else {
                pop_up_note_mode = false;
                au.pause();
                ai.className = 'img-icon';
        ...
        function playbksound() {
            ...
            bg_htm = "<img id='sound_image' src='/static/weixin/images/join-icon.png' class='img-icon play'>";
