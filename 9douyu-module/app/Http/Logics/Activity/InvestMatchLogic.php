...
class InvestMatchLogic extends Logic
{
    ...
    public static function getActivityStatisticsNowDate()
    {
        ...
        return  self::setActivityStatisticsByTime($nowTime,$projectIds,5);
    }
    ...
    {
        return ActivityFundHistoryDb::SOURCE_ACTIVITY_INVEST_MATCH_FIVE;
    }
    /**
     * @return mixed
     * @desc 获取解析的数据
    ...
    private static function getInstance(){
        ...
        if(!(self::$objectExample instanceof self)){
            ...
            self::$objectExample = new AnalysisConfigLogic('ACTIVITY_MATCH_GAME');
        }
