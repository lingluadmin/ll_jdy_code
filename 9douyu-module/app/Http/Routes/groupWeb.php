...
Route::group(['prefix' => '/', 'namespace' => 'Pc' ,'domain'=> $domain], function()
{
    ...
    Route::post('register/doRegister',          'User\RegisterController@doRegister');          // pc 执行注册
...
//    Route::post('resetLoginPassword/sendSms', 'User\LoginController@sendSms');                    //pc 找回登录密码成功页面
    ...
    /**************************  项目列表 ***********************/
    Route::get('project/index',                 'Project\IndexController@index');           // 项目列表
    Route::get('project/sdf',                   'Project\IndexController@sdfList');         // 闪电付息列表
    Route::get('project/debt',                  'Project\IndexController@debt');
    Route::get('project/list/{page}',           'Project\IndexController@getProjectList');  // 分页获取项目列表

    Route::get('project/detail/{id}',           'Project\ProjectDetailController@get');     // 项目详情
    Route::get('project/{id}',                  'Project\ProjectDetailController@get');     // 项目详情
    ...
    /**** 文章相关 ****/
    Route::get('article/{id}',              'Article\ArticleController@detail');        // 文章详情
    /*帮助中心*/
    ...
    Route::get('activity/coupon/packet',            'Activity\CouponController@getLotteryPacket');
