...
/**
 * 九省心三月期债权
 * Class CreditNineThreeModel
 * @package App\Http\Models\CreditLable
 */
class CreditNineThreeModel extends CreditLableModel implements CreditLableInterfaceModel
{
    /**
     * 获取未使用的债权集合
    ...
    public function getUnusedCreditList($condition = []){
        $condition['credit_tag']  = ProjectDb::PRODUCT_LINE_THREE_MONTH;
        $field = [
            'id',
            'source',
            'type',
