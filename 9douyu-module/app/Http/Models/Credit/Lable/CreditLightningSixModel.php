...
/**
 * 闪电付息六月期债权
 * Class CreditLightningSixModel
 * @package App\Http\Models\CreditLable
 */
class CreditLightningSixModel extends CreditLableModel implements CreditLableInterfaceModel
{
    /**
     * 获取未使用的债权集合
    ...
    public function getUnusedCreditList($condition = []){
        $condition['credit_tag']  = ProjectDb::PRODUCT_LINE_LIGHTNING_SIX_MONTH;
        $field = [
            'id',
            'source',
            'type',
