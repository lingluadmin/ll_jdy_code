...
/**
 * 九省心十二月期债权
 * Class CreditNineOneModel
 * @package App\Http\Models\CreditLable
 */
class CreditNineTwelveModel extends CreditLableModel implements CreditLableInterfaceModel
{
    /**
     * 获取未使用的债权集合
    ...
    public function getUnusedCreditList($condition = []){
        $condition['credit_tag']  = ProjectDb::PRODUCT_LINE_TWELVE_MONTH;
        $field = [
            'id',
            'source',
            'type',
