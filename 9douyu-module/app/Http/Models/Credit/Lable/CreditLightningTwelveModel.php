...
/**
 * 闪电付息十二月期债权
 * Class CreditLightningTwelveModel
 * @package App\Http\Models\CreditLable
 */
class CreditLightningTwelveModel extends CreditLableModel implements CreditLableInterfaceModel
{
    /**
     * 获取未使用的债权集合
    ...
    public function getUnusedCreditList($condition = []){
        $condition['credit_tag']  = ProjectDb::PRODUCT_LINE_LIGHTNING_TWELVE_MONTH;
        $field = [
            'id',
            'source',
            'type',
