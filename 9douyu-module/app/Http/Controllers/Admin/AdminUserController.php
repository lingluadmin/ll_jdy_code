...
class AdminUserController extends BaseController
{
    ...
    public function index()
    {
        ...
        $users = $this->adminUser->orderBy('id', 'desc')->paginate(100);
    ...
    {
        $adminUserdb= new AdminUsersDb();
        $maxVerify  = $adminUserdb->getMaxVerify();
        $maxVerify  = $maxVerify +1;
        $password   = ToolStr::getRandStr(6);
        ...
        return view('admin.rbac.admin_users.create',['maxVerify' => $maxVerify, 'password' => $password]);
    }
