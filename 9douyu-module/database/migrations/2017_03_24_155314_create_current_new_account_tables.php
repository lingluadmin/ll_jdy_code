...
class CreateCurrentNewAccountTables extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('current_new_account', function (Blueprint $table) {
            $table->increments('id')->comment('新零钱计划账户');
    ...
    {
        Schema::drop('current_new_account');
    }
}