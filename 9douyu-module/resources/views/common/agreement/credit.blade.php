...
<table border="1">
	<tbody>
		...
		<tr>
			<td rowspan="{{ $realLoanUserNum }}" align="center">{{mb_substr($project['name'],0,6)}} {{$project['format_name']}}</td>
...
<table border="1">
	<tbody>
		...
		<tr>
			<td align="center">{{mb_substr($project['name'],0,6)}} {{$project['format_name']}}</td>
