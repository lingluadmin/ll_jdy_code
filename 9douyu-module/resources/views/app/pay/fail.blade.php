...
@section('content') 
    <article class="app-bg">
        ...
        <section class="app-box">
            ...
            <p class="app-txt1">充值失败</p>
            <!--<p class="app-txt2"><span class="app-color2">支付金额：</span><span class="app-color1">   Session::get('payCash') }}元</span></p>-->
        </section>
        <a href="javascript:void(0);" onClick="gotoInvest()" class="app-btn">立即出借</a>
        <a href="javascript:void(0);" onClick="gotoAccount()" class="app-btn">我的账户</a>
    </article>
