    ...
    <article class="project-bg">
        <div class="project-wrap first">
            ...
            <div class="proj-contrast-main">
                <div class="proj-contrast-txt1">{{$project['product_line_note']}}{{$project['invest_time_note']}}</div>
                <div class="proj-contrast-txt2">银行系</div>
                <div class="proj-contrast-txt3">互联网系</div>
                <div class="proj-contrast-txt4">
                    <p>{{(float)$project['profit_percentage']}}%</p>
                    <p><small>利率</small></p>
                </div>
            ...
            <ul class="proj-profit">
                <li>
                    <p>银行系</p>
                    <p class="orange"><small>预计</small>29.1元</p>
                </li>
                <li>
                    <p>{{$project['product_line_note']}}{{$project['invest_time_note']}}</p>
                    <p class="orange"><small>预计</small><strong>{{$project['hundred_thousand_income']}}元</strong></p>
                </li>
                <li>
                    <p>互联网系</p>
                    <p class="orange"><small>预计</small>375元</p>
                </li>
            </ul>
        </div>
