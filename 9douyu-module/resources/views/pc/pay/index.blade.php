                    ...
                    <div class="v4-account-rapid-info-wrap">
                         ...
                         <div class="v4-account-info">
                            ...
                            <div class="v4-account-card">
                                <p class="cardNum"><img src="{{assetUrlByCdn('/static/images/bank-img/'.$authCard['info']['bank_id'].'.png')}}" class="v4-bank-icon">{{$authCard['info']['bank_name']}} {{ substr($authCard['info']['card_no'],0,4) }}****{{substr($authCard['info']['card_no'],-4)}}</p>
                        ...
                        <dl class="v4-input-group">
                            ...
                            <dd class="clearfix">
                                <div class="v4-recharge-channel-wrap clearfix">
                                    ...
                                    <ul class="v4-recharge-channel" bvalue="{{$val['pay_type']}}" data-cash="{{$val['real_limit']}}">
                                        <li class="v4-recharge-channel-bt"><img src="{{assetUrlByCdn('/static/images/bank-img/'.$val['pay_type'].'.png')}}" width="72" alt="{{$typeList[$val['pay_type']]['name']}}">{{$typeList[$val['pay_type']]['name']}}<span></span></li>
                                        <li class="v4-recharge-channel-txt clearfix"><span class="fl">单笔限额</span><em class="fr">{{ $val['limit'] or 0 }}元</em></li>
                                        <li class="v4-recharge-channel-txt clearfix"><span class="fl">当日限额剩余</span><em class="fr">{{ $val['day_free_limit'] or 0 }}元</em></li>
                                    </ul>
                                    @endforeach
                                </div>
                            </dd>
                            ...
                            <dd>
                                ...
                                <input type="hidden"    name="bankId"   value="{{ $authCard['info']['bank_id'] }}"/>
