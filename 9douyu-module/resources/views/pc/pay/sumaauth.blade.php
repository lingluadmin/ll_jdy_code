...
<div class="wrap">
    <div class="logo">
        <a href="http://www.9douyu.com"><img src="{{ assetUrlByCdn('/static/images/new/x-logo-small-1.png') }}"></a>
    </div>
    <div class="box">
        <div class="box-title">
            <div class="box-info">
            ...
            <div class="box-sum">
                <p>充值金额：<span>{{ $cash }} 元</span></p>
            </div>
        </div>
        <div class="main-title">借记卡付款</div>
        <div class="main">
            <form action="{{ URL('/recharge/sumaSubmit') }}" method="post" id="rechargeSub">
                <div class="main-group">
                    <label>银行卡</label><input type="text" class="main-group-input" name="card_no" value="{{ $cardNo }}" readonly="true">
                </div>
                <div class="main-group">
                    <label>姓名</label><input type="text" class="main-group-input" name="name" value="{{ $realName }}" readonly="true">
                </div>
                <div class="main-group">
                    <label>身份证号码</label><input type="text" class="main-group-input" name="id_card" value="{{ $identityCard }}" readonly="true">
                </div>
                <div class="main-group">
                    <label>手机号</label><input type="text" class="main-group-input" placeholder="请输入银行预留手机号" value="{{ $phone }}" name="phone" readonly="true">
                </div>
                <div class="main-group">
                    <label>短信验证码</label>
