                                ...
                                <div class="v4-recharge-bank">
                                    <ul class="clearfix">
                                        @foreach($unionPay as $union)
                                            @if( $union['bank_id'] == $bankId )
                                                <li bvalue="{{ $union['bank_id'] }}" data-alias="{{ $union['alias'] }}" class="active" ><img src="{{assetUrlByCdn('/static/images/bank-img/'.$union['bank_id'].'.gif')}}"/><span></span></li>
                                            @else
                                                <li bvalue="{{ $union['bank_id'] }}" data-alias="{{ $union['alias'] }}" ><img src="{{assetUrlByCdn('/static/images/bank-img/'.$union['bank_id'].'.gif')}}"/><span></span></li>
                                            @endif
                                        @endforeach
                                    </ul>
                                </div>
