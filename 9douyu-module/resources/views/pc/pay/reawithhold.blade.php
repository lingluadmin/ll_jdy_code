...
<div class="wrap">
    ...
    <div class="box">
        ...
        <div class="main">
            <form action="{{ URL('/pay/reaSubmit') }}" method="post" id="rechargeSub">
                <div class="main-group">
                    <label>银行卡</label><input type="text" class="main-group-input" name="card_no" value="{{ $cardNo }}">
                </div>
                <div class="main-group">
                    <label>姓名</label><input type="text" class="main-group-input" name="name" value="{{ $realName }}">
                </div>
                <div class="main-group">
                    <label>身份证号码</label><input type="text" class="main-group-input" name="id_card" value="{{ $identityCard }}">
                </div>
                <div class="main-group">
