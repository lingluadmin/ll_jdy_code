<div class="v4-wrap-margin clearfix">
    <a href="{{!empty($ad['noviceLeft']['url']) ? $ad['noviceLeft']['url'] : '/Novice/extension'}}" class="v4-novice-banner">
        <img src="{{!empty($ad['noviceLeft']['purl']) ? $ad['noviceLeft']['purl'] : assetUrlByCdn('/static/images/pc4/index/v4-novice-banner.jpg')}}" width="200" height="200">
    </a>
    ...
    <a href="javascript:;" class="v4-AD">
        <img src="{{!empty($ad['noviceRight']['purl']) ? $ad['noviceRight']['purl'] : assetUrlByCdn('/static/images/pc4/index/v4-AD.jpg')}}" width="290" height="200">
    </a>
</div>