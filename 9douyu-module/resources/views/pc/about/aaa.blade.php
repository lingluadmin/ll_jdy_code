...
<link rel="stylesheet" type="text/css" href="{{assetUrlByCdn('/static/css/pc4/aaa.css')}}">
<style type="text/css">
...
<div class="aaa-bg">
    <div class="aaa-wrap">
        ...
        <div class="aaa-info-img">
            <p><a href="{{assetUrlByCdn('/static/images/pc4/compliance/compliance-pic4.jpg')}}" rel='example_group'><img src="{{assetUrlByCdn('/static/images/pc4/aaa/aaa.png')}}" width="203" height="334" ></a></p>
            <p>九斗鱼AAA评级证书</p>
        </div>
        <div class="clear"></div>
