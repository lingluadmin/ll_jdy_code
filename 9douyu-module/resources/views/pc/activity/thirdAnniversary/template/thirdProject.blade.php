<div class="anniversary-box bottom1" ng-controller="projectCtrl">
    <div class="anniversary-title">嘉年华专享</div>
    <div class="anniversary-pro-block" ng-repeat="project in projectList">
        <a href="javascript:;" class="investClick" attr-data-id="<%project.id%>">
            <table>
                <tr>
                    <th colspan="5" ><span ng-bind="project.product_line_note"></span><i>•</i> <span class="anniversary-orange" ><span ng-bind="project.invest_time_note">3月期</span> <span ng-bind="project.id"></span></span></th>
                </tr>
                <tr>
                    <td width="20%">
                        <p class="anniversary-orange"><big ng-bind="project.profit_percentage | number:1">11</big>％</p>
                        <p><small>借款利率</small></p>
                        <ins class="anniversary-line"></ins>
                    </td>
                    <td width="18%">
