    ...
    <div class="current-operate clearfix">
        ...
        <div class="current-operate-box">
            ...
            <div class="current-unlogin">
                <p class="current-operate-account">可用余额<span><a href='/login'>登录</a>可见</span>
                </p>
                ...
                <p class="current-warm">温馨提示：网贷有风险，出借需谨慎。</p>
            </div>
            ...
            @else
                <!-- 登录可投资 -->
            <p class="current-operate-account">可用余额<span>{{ number_format($balance,2) }}元</span>
        ...
        <div class="js_tab_content">
            <div class="Js_tab_main t-question-main" style="display: block">
                ...
                @else
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td class="tc">投资限额</td>
                            <td>可用余额投资限额20万元（回款本息自动投资部分不计算在内）</td>
                            {{--<td class="tc">转入限额</td>--}}
                            {{--<td>单人转入限额{{ $investMax/10000 }}万元（包括回款本息自动转入部分）</td>--}}
                        </tr>
                        <tr>
                            <td class="tc">转出限额</td>
                        ...
                        <tr>
                            <td class="tc">持有限额</td>
                            <td>每个账户持有金额上限为{{ $investMax/10000 }}万元</td>
                        </tr>
                    </table>
                @endif
            </div>
            <dl class="Js_tab_main t-question-main">
                ...
                @else
                    ...
                    <dt>2.怎么加入零钱计划？</dt>
                    <dd>
                        <p>2.1、登录九斗鱼账户，选择零钱计划并输入加入金额，可将可用余额（整数部分）转入到零钱计划中，享受资金不站岗天天拿收益。</p>
                    ...
                    <dd>每日回款金额（整数部分）自动加入零钱计划，可用余额暂不支持自动转入零钱计划。</dd>
