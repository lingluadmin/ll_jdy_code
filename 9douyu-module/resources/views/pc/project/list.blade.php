...
@section('content')
    <div class="v4-wrap">
        <div class="v4-project-banner">
            <a href="javascript:;"><img src="{{ !empty($ad[0]['purl']) ? $ad[0]['purl'] : assetUrlByCdn('/static/images/pc4/project/v4-project-banner.jpg')}}" width="1100" height="180"></a>
        </div>
                ...
                <div class="js_tab_content">
                            ...
                            <li ms-for="(k, v) in @list" ms-if="@v.status==130">
                                ...
                                <div class="v4-listitem-box v4-listitem-rate">
                                    <p style="color:red">
                                        ...
                                        {{--<big ms-if="@v.after_rate<=0">{% @v.profit_percentage | number(1) %}%</big>--}}
                   ...
                   <!--智投项目列表-->
                    <div class="Js_tab_main" ms-visible="@toggle==2">
                        ...
                        <ul class="v4-project-listitem">
                            <li ms-for="(k, v) in @smart_list" ms-if="@v.status==130 && @v.raise_over==false" >
                                <div class="v4-listitem-box v4-listitem-title">
                                    <p>
                                        <big><span class="v4-mr15">{% @v.name %} </span> {% @v.format_name %}</big>
                                    </p>
                                ...
                                <div class="v4-listitem-box v4-listitem-btnbox">
                                    <a class="v4-listitem-btn" ms-if="@v.raise_over==false" ms-attr="{href:'/smartInvest/detail/' + v.id}">立即出借</a>
                                </div>
                            </li>

                            <li ms-for="(k, v) in @smart_list" ms-if="@v.status==130 && @v.raise_over==true" class="v4-listitem-soldout">
                                <div class="v4-listitem-box v4-listitem-title">
                                    <p>
                                        <big><span class="v4-mr15">{% @v.name %} </span> {% @v.format_name %}</big>
                                    </p>
                                ...
                                <div class="v4-listitem-box v4-listitem-btnbox">
                                    <a class="v4-listitem-btn" ms-attr="{href:'/smartInvest/detail/' + v.id}">募集期结束</a>
                                </div>
                            </li>
