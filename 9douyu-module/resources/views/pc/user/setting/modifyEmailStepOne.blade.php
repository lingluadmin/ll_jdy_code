...
<div class="v4-account">
    ...
    <div class="v4-content v4-account-white">
        ...
        <div class="v4-custody-main v4-phone-main">
            <form action="/user/modify/email/stepTwo" method="post"  id="modifyEmailStepOne">
                ...
                <dl class="v4-input-group">
                    ...
                    <dd>
                        ...
                        <input value="获取验证码" type="button" class="v4-input-code" default-value='获取验证码' id="code">
...
$(function(){
 // 检验输入框内容
        $.validation('.v4-input');
    // 表单提交验证
         $("#modifyEmailStepOne").bind('submit',function(){
        });
