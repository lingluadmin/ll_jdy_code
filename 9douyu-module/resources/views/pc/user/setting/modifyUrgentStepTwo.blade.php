...
<div class="v4-account">
    ...
    <div class="v4-content v4-account-white">
        ...
        <div class="v4-custody-main v4-phone-main">
            <form action="/user/setting/doUrgentPhone" method="post"  id="modifyUrgentStepTwo">
                <input name='setting' value="modify" type="hidden"/>
                ...
                <dl class="v4-input-group">
                    ...
                    <dd>
                        <input type="text"  name="urgent_phone" id="urgent_phone" placeholder="请输入11位手机号" data-pattern="registerphone"  class="v4-input"/>
...
$(function(){
 // 检验输入框内容
    ...
    // 表单提交验证
         $("#modifyUrgentStepTwo").bind('submit',function(){
            if(!$.formSubmitF('.v4-input',{
                fromT:'#modifyUrgentStepTwo'
            })) return false;
        });
