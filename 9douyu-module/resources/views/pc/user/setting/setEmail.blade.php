...
<div class="v4-account">
    ...
    <div class="v4-content v4-account-white">
        <h2 class="v4-account-titlex">设置常用邮箱</h2>
        <div class="v4-custody-main v4-phone-main">
            <form action="" method="post"  id="setEmail">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="setting" value="set">
