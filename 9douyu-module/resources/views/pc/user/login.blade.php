                ...
                <div class="v4-reg-right">
                    <div class="Js_tab_box v4-reg-tab">
                        <ul class="Js_tab_click v4-reg-main">
                            <li class="@if($action == 'login') cur @endif">登录</li>
                            <li class="@if($action == 'register') cur @endif">注册</li>
                        </ul>
                        <div class="Js_tab_main_click" @if($action == 'register') style="display: none;" @endif>
                        ...
                        <div class="Js_tab_main_click" @if($action == 'login') style="display: none;" @endif>
...
<!--                                     <input value="60s后重新获取" type="button" class="v4-input-code disable">
 -->                            </li>
                            ...
                            <input type="hidden" name="channel" value="{{$channel}}" class="mr5">
