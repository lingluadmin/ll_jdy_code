...
<div class="v4-account">
    ...
    <div class="v4-content v4-account-white">
        <h2 class="v4-account-titlex">修改登录密码</h2>
        <div class="v4-custody-main v4-phone-main">
            <form action="/user/doPassword" method="post" id="modifyloginpassword">
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                 <dl class="v4-input-group">
                    ...
                    <dd>
                        <input value="" type="password" name="oldPassword" placeholder="请输入6~16位字母和数字的组合" id="password" data-pattern="passwordOld" class="v4-input">
                    ...
                    <dd>
                        <input value="" type="password" name="newPassword" placeholder="请输入6~16位字母和数字的组合" id="password2" data-pattern="password" class="v4-input">
...
<script type="text/javascript">
 ...
 $(function(){
    ...
    // 表单提交验证
         $("#modifyloginpassword").bind('submit',function(){
            if(!$.formSubmitF('.v4-input',{
                fromT:'#modifyloginpassword'
            })) return false;
        });
          // 密码的eye开关
