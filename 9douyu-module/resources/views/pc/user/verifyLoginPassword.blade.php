...
<div class="v4-wrap v4-custody-wrap">
        ...
        <div class="v4-custody-main">
            <form action="/doForgetPassword" method="post" id="identityPasswordForm">
                ...
                <dl class="v4-input-group">
                    ...
                    <dd>
                        <input name="realName" value="{{ old('realName') }}" placeholder="请输入真实姓名" id="name" data-pattern="name" class="v4-input">
                    ...
                    <dd>
                        <input name="identityCard" value="{{ old('identityCard') }}" placeholder="请输入身份证号" id="idcard" data-pattern="idcard" class="v4-input">
                        <span class="v4-input-status"><i class="t1-icon v4-iconfont"></i></span>
                    </dd>
                    <dt>
                        &nbsp;
