<div class="v4-top">
    <div class="v4-wrap">
        ...
        <div class="v4-top-nav-wrap">
            <ul class="v4-top-nav">
                @if(!empty($view_user))
                    <li class="v4-top-nav-account">您好，@if(!empty($view_user['real_name'])) {{ $view_user['real_name']}} @else {{ \App\Tools\ToolStr::hidePhone($view_user['phone'], 3, 4)}}  @endif  <a href="{{url('logout')}}">[退出]</a></li>
                @endif
