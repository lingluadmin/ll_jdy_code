<div class="v4-footer-bottom">
    <div class="v4-wrap hidden">
        <div class="v4-footer-copyright">
            <p>星果时代信息技术有限公司版权所有&nbsp;&nbsp;京ICP备16011752号-1&nbsp;&nbsp;<a href="http://www.beian.gov.cn/portal/registerSystemInfo" rel='nofollow' target="_blank"><img src="{{ assetUrlByCdn('/static/images/pc4/v4-installation.png') }}" width="20" height="20"> 京公网安备 11010502033496号</a></p>
            <p>Copyright©2017 9douyu. All Right Reserved&nbsp;&nbsp; &nbsp;&nbsp;    风险提示：网贷有风险，出借需谨慎</p>
        </div>
        <div class="v4-footer-checkwebsite">
            <ul>
                {{--<li><a href="/home/util/cnnic" target="_blank" rel="nofollow" class="v4-footer-icon"></a></li>--}}
                {{--<li><a href="http://webscan.360.cn/index/checkwebsite?url=www.9douyu.com" target="_blank" rel="nofollow" class="v4-footer-icon1"></a></li>--}}
                ...
                {{--<li><a href="http://gawa.bjchy.gov.cn/websearch/" target="_blank" rel="nofollow" class="v4-footer-icon3"></a></li>--}}
