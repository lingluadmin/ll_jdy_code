                ...
                <form name="form1" action="" method="get">
                    <div class="control-group">
                         <label class="" for="">键名KEY:
                             ...
                             <a style="margin-left: 50px;margin-bottom: 5px;"class="btn btn-small btn-success" href="/admin/activity_config/create">添加配置</a>
                        ...
                        <div class="box-content">
                            <table class="table table-bordered table-striped table-condensed">
                                ...
                                @foreach( $list as $key => $item )
                                    <tr>
                                        <td class="center">
                                            <a href="/admin/activity_config/update?id={{ $item['id'] }}"><span class="label label-warning">编辑</span></a>
                                        </td>
