...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="javascript:void(0)">渠道编辑</a></li>
    </ul>
    <!-- start: Content -->
    <form role="form" enctype="multipart/form-data" action="/admin/media/channel/doEdit" method="post">
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header" data-original-title>
                    <h2><i class="halflings-icon edit"></i><span class="break"></span>渠道编辑</h2>
                    <div class="box-icon">
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                            ...
                            <div class="controls">
                                <select id="bank_id" data-rel="chosen" name="group_id">
                                    @foreach($group_list as $val)
                                        <option value="{{$val['id']}}" @if($group_id == $val['id']) checked="checked" @endif>{{$val['name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="url" name="url" value="{{ Input::old('url',$url) }}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="package" name="package" value="{{ Input::old('package',$package) }}">
                                <span style="color:red;margin-left: 30px;">填完整的包名即可,例如:jiudouyu2.2.106_1411644jrtt_download6.apk</span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="start_date" id="start_date" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd'})" value="{{Input::old('start_date',$start_date)}}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="end_date" id="end_date" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd'})" value="{{Input::old('end_date',$end_date)}}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="award_key" name="award_key" value="{{ Input::old('award_key',$award_key) }}">
