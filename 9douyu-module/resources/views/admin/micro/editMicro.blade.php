    ...
    <div class="row-fluid sortable ui-sortable">
        ...
        <div class="box">
            <div class="box-header">
                <h2><i class="halflings-icon align-justify"></i><span class="break"></span>编辑微刊数据</h2>
            </div>

            <div class="box-content">
                <form id='editMicro' class="form-horizontal" method="post" action="/admin/micro/doEditMicro" enctype="multipart/form-data" >
                    <input type="hidden" class="span3 typeahead" name="id"   value="{{$info['id']}}">
                    <input type="hidden" class="span3 typeahead" name="picture_id" value="{{$info['picture_id']}}">
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="typeahead">微刊刊号</label>
                            <div class="controls">
                                <input type="text" class="span3 typeahead" name="date"  id="micro_date" value="{{$info['date']}}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span4 typeahead" name="link" id="micro_link" value="{{$info['link']}}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span4 typeahead" name="title" id="micro_title" value="{{$info['title']}}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="span4 typeahead" name="content">{{$info['content']}}</textarea>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="status" >
                                    <option value="200" @if($info['status']== \App\Http\Dbs\Micro\MicroJournalDb::RELEASE_STATUS_IS_OPEN) selected="true" @endif>开启</option>
                                    <option value="100" @if($info['status']== \App\Http\Dbs\Micro\MicroJournalDb::RELEASE_STATUS_IS_CLOSED) selected="true" @endif>关闭</option>
                                </select>
