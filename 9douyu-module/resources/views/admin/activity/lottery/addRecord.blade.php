...
@section('content')
    ...
    <form id="addLotteryRecord"  action="/admin/lottery/doAddRecord" method="post">

        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header" data-original-title>
                    <h2><i class="halflings-icon edit"></i><span class="break"></span>补充中奖记录</h2>
                </div>
                ...
                <div class="box-content form-horizontal">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            @foreach($activityNote as $key => $value)
                                <option value="{{$key}}_{{$value['group']}}">{{$value['name']}}</option>
                            @endforeach
                            </select>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge focused" id="number" type="text" name="phone" value="" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="lottery_time"  onclick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})" value="" placeholder="中奖时间">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="selectError">添加说明</label>
                        <div class="controls">
                            <textarea name="note" id="lottery"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-small btn-primary">添加记录</button>
                        </div>
                    </div>
                </div>
            </div>
