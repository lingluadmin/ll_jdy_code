                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <div class="btn-group mr10">
                                <a href="{{ route('admin.role.create', [], false) }}" class="btn btn-white tooltips"
                                   data-toggle="tooltip" data-original-title="新增"><i
                                            class="glyphicon glyphicon-plus"></i></a>
                                <a class="btn btn-white tooltips deleteall" data-toggle="tooltip"
                                   data-original-title="删除" data-href="{{ route('admin.role.destroy.all', [], false) }}"><i
                            ...
                            <table class="table mb30">
                                ...
                                @foreach($roles as $role)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.role.edit',['id'=>$role->id], false) }}"
                                               class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 编辑</a>
                                            <a href="{{ route('admin.role.permissions',['id'=>$role->id], false) }}"
                                            class="btn btn-info btn-xs role-permissions"><i class="fa fa-wrench"></i> 权限</a>
                                            <a class="btn btn-danger btn-xs role-delete"
                                               data-href="{{ route('admin.role.destroy',['id'=>$role->id], false) }}">
