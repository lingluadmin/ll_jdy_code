        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-lg-10">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.permission.update',['id'=>$permission->id] ,false) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="name"
                                           ...
                                           data-original-title="不可重复,不可点击路由输入`#`" value="{{ $permission->name }}" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="icon"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="图标名称,去fa-前缀" value="{{ $permission->icon }}">
                                </div>
                            </div>
