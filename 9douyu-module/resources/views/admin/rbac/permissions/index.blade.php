                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <div class="btn-group mr10">
                                <a href="{{ route('admin.permission.create', [], false) }}" class="btn btn-white tooltips"
                                   data-toggle="tooltip" data-original-title="新增"><i
                                            class="glyphicon glyphicon-plus"></i></a>
                                <a class="btn btn-white tooltips deleteall" data-toggle="tooltip"
                                   data-original-title="删除" data-href="{{ route('admin.permission.destroy.all', [], false) }}"><i
                            ...
                            <table class="table mb30">
                                ...
                                @foreach($permissions as $permission)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.permission.edit',['id'=>$permission->id], false) }}"
                                               class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑</a>
                                            <a class="btn btn-danger btn-sm permission-delete"
                                               data-href="{{ route('admin.permission.destroy',['id'=>$permission->id], false) }}"><i
                                    ...
                                    @if($permission->sub_permission->count())
                                        @foreach($permission->sub_permission as $sub)
                                            <tr class="hide parent-permission-{{ $permission->id }}">
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.permission.edit',['id'=>$sub->id] ,false) }}"
                                                       class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑</a>
                                                    <a class="btn btn-danger btn-sm permission-delete"
                                                       data-href="{{ route('admin.permission.destroy',['id'=>$sub->id], false) }}"><i
                                                                class="fa fa-trash-o"></i> 删除</a>
...
@section('javascript')
    @parent
    <script src="{{ assetUrlByCdn('js/admin/ajax.js') }}"></script>
    <script>
