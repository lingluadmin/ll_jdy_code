        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-lg-10">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.admin_user.update',['id'=>$user->id], false) }}" method="POST">
                        ...
                        <div class="panel-body panel-body-nopadding">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">工号 <span class="asterisk">*</span></label>

                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="verify"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="请输入工号" value="{{ $user->verify }}">
                                </div>
                            </div>
