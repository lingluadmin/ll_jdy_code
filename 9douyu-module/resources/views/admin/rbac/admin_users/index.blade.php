                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <div class="btn-group mr10">
                                <a href="{{ route('admin.admin_user.create', [], false) }}" class="btn btn-white tooltips"
                            ...
                            <table class="table mb30">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.admin_user.edit',['id'=>$user->id], false) }}"
                                               class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 编辑</a>
                                            <a class="btn btn-danger btn-xs user-delete"
                                               data-href="{{ route('admin.admin_user.destroy',['id'=>$user->id], false) }}">
