...
@section('content')
    ...
    <!-- start: Content -->
    <form role="form" action="/admin/article/category/doUpdate" method="post">
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                                    ...
                                    <select name="parent_id">
                                        ...
                                        @if( !empty($category) )
                                            @foreach( $category as $key => $item)
                                                <option value="{{ $item['id'] }}" @if($item['id'] == $info['id']) selected @endif>{{ $item['name'] }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused not_null" type="text" name="alias" value="{{ Input::old('alias', $info['alias']) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused not_null" type="number" min="0" name="sort_num" value="{{ Input::old('sort_num', $info['sort_num']) }}">
                                </div>
                            </div>
                        </div>
