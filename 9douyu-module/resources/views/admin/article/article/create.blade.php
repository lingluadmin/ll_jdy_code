...
<!-- start: Content -->
    <form role="form" action="/admin/article/doCreate" method="post" enctype="multipart/form-data">
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio">
                                    <span class="checked"><input name="is_push" value="0" checked="" type="radio"></span>
                                    不推送
                                </label>
                                <div style="clear:both"></div>
                                <label class="radio">
                                    <span class=""><input name="is_push" value="1" type="radio"></span>
                                    推送
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio">
                                    <span class=""><input name="type_id" value="1" type="radio" checked></span>
                                    文章资讯
                                </label>
                                <div style="clear:both"></div>
                                <label class="radio">
                                    <span class=""><input name="type_id" value="2" type="radio"></span>
                                    媒体合作
                                </label>
                            </div>
                        </div>

                        {{--<div class="form-group row" id="notice_type" style="display:none">--}}
                            {{--<label class="control-label col-lg-1 textr">三端</label>--}}
                            {{--<div class="col-lg-3">--}}
                                {{--<input type="checkbox" name="notice_type[]" value="pc" checked="checked">PC--}}
                                {{--<input type="checkbox" name="notice_type[]" value="wap" >WAP--}}
                                {{--<input type="checkbox" name="notice_type[]" value="app" >APP--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused not_null" type="text" name="title" value="{{ Input::old('title') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-content form-horizontal">
                            <fieldset>
                                ...
                                <div class="control-group hidden-phone">
                                    ...
                                    <div class="controls">
                                        <textarea class="form-control" id="description" name="intro" style="height: 5px;"> {{ Input::old('description') }}  </textarea>
                                ...
                                <div class="control-group hidden-phone">
                                    ...
                                    <div class="controls">
                                        <textarea class="form-control" id="content_editor" name="content"> {{ Input::old('content') }}  </textarea>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused not_null" type="text" min="0" name="keywords" value="{{ Input::old('keywords') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <textarea name="description" rows="2" cols="120" style="width: 40rem; height: 3rem;" ></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused not_null" type="number" min="0" name="sort_num"  placeholder="序号越小越靠前" value="{{ Input::old('sort_num') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio">
                                    <span class="checked"><input name="is_top" id="optionsRadios1" value="0" checked="" type="radio"></span>
                                    不置顶
                                </label>
                                <div style="clear:both"></div>
                                <label class="radio">
                                    <span class=""><input name="is_top" id="optionsRadios2" value="1" type="radio"></span>
                                    置顶
                                </label>
                            </div>
                        </div>
