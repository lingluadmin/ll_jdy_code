...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="javascript:void(0)">创建耀盛信贷债权</a></li>
    </ul>
    <!-- start: Content -->
    <form role="form" action="/admin/credit/doCreate/loan" method="post">
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="date01" name="founded_time" value="{{ Input::old('founded_time') }}">
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="date01" name="registered_capital" value="{{ Input::old('registered_capital') }}">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="date01">年收入</label>
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="date01" name="annual_income" value="{{ Input::old('annual_income') }}">
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor1" id="textarea3"rows="5" cols="80" name="loan_use"> {{ Input::old('loan_use') }} </textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor1" id="textarea3"rows="5" cols="80" name="background"> {{ Input::old('background') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor1" id="textarea3"rows="5" cols="80" name="financial"> {{ Input::old('financial') }}</textarea>
                            </div>
                        </div>
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="date01" name="home_stability" value="{{ Input::old('home_stability') }}">
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor1" id="textarea3"rows="5" cols="80" name="esteemn"> {{ Input::old('esteemn') }}</textarea>
                            </div>
                        </div>
            ...
            <div class="box span12">
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        ...
                        <div class="control-group hidden-phone">
                            <div class="controls">
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[license]" name="submit_data[license]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[license]">营业执照认证 </label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[tax_submit_dataority]" name="submit_data[tax_submit_dataority]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[tax_submit_dataority]">税务登记证认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[organization_code]" name="submit_data[organization_code]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[organization_code]">组织机构代码认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[bank_account_cert]" name="submit_data[bank_account_cert]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[bank_account_cert]">开户许可证认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[company_rule]" name="submit_data[company_rule]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[company_rule]">公司章程认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[capital_verified_report]" name="submit_data[capital_verified_report]" type="checkbox"></div>
                                ...
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[qualification]" name="submit_data[qualification]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[qualification]">公司资质认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[representative]" name="submit_data[representative]" type="checkbox"></div>
                                ...
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[controller]" name="submit_data[controller]" type="checkbox"></div>
                                ...
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[premise]" name="submit_data[premise]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[premise]">经营场所证明文件认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[residence]" name="submit_data[residence]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[residence]">实际控制人住所证明文件认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[business_info]" name="submit_data[business_info]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[business_info]">经营资料证明文件认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[house_property]" name="submit_data[house_property]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[house_property]">房产认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[car]" name="submit_data[car]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[car]">车辆认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[onsite]" name="submit_data[onsite]" type="checkbox"></div>
                                    <label class="control-label col-lg-5"  style="width:600px; text-align:left;"for="submit_data[onsite]">实地认证</label>
                                </div>
                                <div class="row"><div class="col-lg-2 textr"><input checked="" id="submit_data[other]" name="submit_data[other]" type="checkbox"></div>
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor1" id="textarea3"rows="5" cols="80" name="risk_control_security"> {{ Input::old('risk_control_security') }}</textarea>
                            </div>
                        </div>
                    </fieldset>
                </div>
