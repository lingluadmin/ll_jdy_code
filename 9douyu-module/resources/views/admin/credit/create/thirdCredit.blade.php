...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="javascript:void(0)">创建第三方债权</a></li>
    </ul>
    <!-- start: Content -->
    <form role="form" action="/admin/credit/doCreate/third" method="post" enctype="multipart/form-data">
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor1" id="project_desc"rows="5" cols="80" name="project_desc"> {{ Input::old('project_desc') }}</textarea>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor1" id="risk_control"rows="5" cols="80" name="risk_control"> {{ Input::old('risk_control') }}</textarea>
