                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="date01" name="program_no"  value="{{ $obj['program_no'] or null }}">
                            </div>
                        </div>
                    </fieldset>
                </div>
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="form-control" id="file" name="file"> {{ $obj['file'] or null }}   </textarea>
