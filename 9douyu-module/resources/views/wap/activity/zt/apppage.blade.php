...
<img src="{{assetUrlByCdn('/static/weixin/images/wap4/apppage/logo-9douyu.png')}}" alt="" class="app-logo-9douyu">
<p class="app-text">江西银行直接存管</p>
<input  type="hidden" id="jumpUrl" value="{{ $jumpUrl }}">
<input  type="hidden" id="downUrl" value="{{ $downUrl }}">
