...
<div id="wrapper">
        <div class="scroller">
            <p class="v4-record-date">2017年05月</p>
            ...
            <p class="v4-record-date">2017年04月</p>
            <div class="v4-record-list">
                <section>
                    <p class="clearfix"><span class="type">成功提现</span><em class="total v4-status-green">-10000.00元</em></p>
                    <p class="clearfix"><span class="date">2017年09月01日 12:01</span><em class="balance">可用余额 100.00</em></p>
                </section>
                 <section>
                    <p class="clearfix"><span class="type">提现手续费</span><em class="total v4-status-green">0.00元</em></p>
                    <p class="clearfix"><span class="date">2017年09月01日 12:01</span><em class="balance">可用余额 100.00</em></p>
                </section>
                 <section>
                    <p class="clearfix"><span class="type">提现手续费</span><em class="total v4-status-red">+100.00元</em></p>
                    <p class="clearfix"><span class="date">2017年09月01日 12:01</span><em class="balance">可用余额 100.00</em></p>
                </section>
            </div>
            <p class="v4-record-date">2017年03月</p>
            <div class="v4-record-list">
                <section>
                    <p class="clearfix"><span class="type">充值</span><em class="total v4-status-red">+10000.00元</em></p>
                    <p class="clearfix"><span class="date">2017年09月01日 12:01</span><em class="balance">可用余额 100.00</em></p>
...
<section class="v4-record-filter" data-filter="layer">
    ...
    <div class="main" data-filter="btn">
        ...
        <a href="javascript:;">定期投资</a>
        <a href="javascript:;">定期回款</a>
