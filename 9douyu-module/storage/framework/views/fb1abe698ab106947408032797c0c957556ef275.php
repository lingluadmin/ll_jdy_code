        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        <input type="hidden" name="id" value="<?php echo e($projectInfo['id']); ?>">
                        <?php /*产品线*/ ?>
                        <div class="control-group">
                            <label class="control-label" for="selectProductLine"> 产品线 </label>
                            <input type="hidden" name="product_line" value="<?php echo e($productId); ?>">
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused" id="name" type="text" name="name" value="<?php echo e(Input::old('name',$projectInfo['name'])); ?>">
                                </div>
                            </div>
                        </div>
                        <?php /*融资时间*/ ?>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused" id="date02" type="text" name="invest_days" value="<?php echo e(Input::old('invest_days', $projectInfo['invest_days'])); ?>" placeholder="期限不能大于20天"><span class="add-on"> 天 </span>
                                </div>
                            </div>
                        </div>
                        <?php /*预计年利率*/ ?>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge " id="focusedInput" type="text" name="base_rate" value="<?php echo e(Input::old('base_rate', $projectInfo['base_rate'])); ?>"><span class="add-on"> + </span>
                                    <input class="input-xlarge " id="a" type="text" name="after_rate" value="<?php echo e(Input::old('after_rate', $projectInfo['after_rate'])); ?>"><span class="add-on"> % </span>
                                </div>
                            </div>
                        </div>
                        <?php /*还款方式*/ ?>
                            ...
                            <div class="controls">
                                <select id="refund_type" name="refund_type" data-rel="chosen">
                                    <?php foreach($refundType as $key => $title): ?>{
                                        <?php if($projectInfo['refund_type'] == $key): ?>
                                        <option value="<?php echo e($key); ?>" selected><?php echo e($title); ?></option>";
                                            <?php else: ?>
                                        <option value="<?php echo e($key); ?>"><?php echo e($title); ?></option>";
                                    <?php endif; ?>
                            ...
                            <div class="controls">
                                <select id="category" name="category" data-rel="chosen">
                                    <?php foreach($categoryList as $key => $category): ?>
                                        <?php if( $projectInfo['category'] == $key): ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="publish_time" id="publish_time" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})" value="<?php echo e(Input::old('publish_time', $projectInfo['publish_at'])); ?>">
                            </div>
                        </div>
                        <?php /*项目期限*/ ?>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused" id="date02" type="text" name="invest_time" value="<?php echo e(Input::old('invest_time', $projectInfo['invest_time'])); ?>"><span class="add-on"> <?php echo e($investNote); ?> </span>
                                </div>
                            </div>
                        </div>
                        <?php /*到期日期*/ ?>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge datepicker" id="end_at" name="end_at" value="<?php echo e(Input::old('end_at', $projectInfo['end_at'])); ?>">
                            </div>
                        </div>
                        <?php /*项目金额*/ ?>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused" id="date02" type="text" name="total_amount" value="<?php echo e(Input::old('total_amount', $projectInfo['total_amount'])); ?>"><span class="add-on"> 元 </span>
                                </div>
                            </div>
                        </div>
                        <?php /*普付宝专享*/ ?>
                        <?php /*<div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused" id="date02" type="checkbox" name="pledge" value="1" <?php if( $projectInfo['pledge'] ): ?>checked="true"<?php endif; ?> />
                                ...
                                <div class="input-prepend input-append">
                                    <select id="category" name="newcomer" data-rel="chosen">
                                        ...
                                        <?php foreach($activityList as $key => $activity): ?>
                                            <option value="<?php echo e($key); ?>" <?php if( isset($activityNote['type']) && $activityNote['type'] == $key ): ?> selected <?php endif; ?>><?php echo e($activity); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <label>
                                        <input class="input-xlarge focused" type="radio" name="pledge" <?php if(Input::old('pledge') == 1 || $projectInfo['pledge'] == 1): ?> checked <?php endif; ?> value="1">
                                        <span class="add-on"> 新手专享 </span>
                                    </label>
                                    <label>
                                        <input class="input-xlarge focused" type="radio" name="pledge" <?php if(Input::old('pledge') == 2 || $projectInfo['pledge'] == 2): ?> checked <?php endif; ?> value="2">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="" name="is_credit_assign" data-rel="chosen">
                                    <?php if($projectInfo['is_credit_assign'] === 1): ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused" id="date02" type="text" name="assign_keep_days" value="<?php echo e(Input::old('assign_keep_days', $projectInfo['assign_keep_days'])); ?>"><span class="add-on"> 天 </span>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <tbody>
                            <?php if(is_array($creditList) && !empty($creditList)): ?>
                                <?php foreach($creditList as $key => $info): ?>
                                    <?php $checkBoxType = ''; ?>
                                    <?php foreach($projectInfo['credit_id'] as $creditId): ?>
                                        <?php if($info['id'] == $creditId): ?>
                                            <?php
                                    ...
                                    <?php endforeach; ?>
                                    <tr>
                                    <td><input type="checkbox" name="credit_id[<?php echo e($info['id']); ?>]" value="<?php echo e($info['id']); ?>" <?php echo e($checkBoxType); ?>></td>
