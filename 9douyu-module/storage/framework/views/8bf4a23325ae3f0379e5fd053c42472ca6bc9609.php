<div class="v4-wrap v4-wrap-margin v4-news clearfix" >
    <div class="v4-media">
   		<a href="<?php echo e(!empty($ad['mediaShow']['url']) ? $ad['mediaShow']['url'] : 'https://www.sunholding.com.cn/article/202.html'); ?>" title="<?php echo e(!empty($ad['mediaShow']['word']) ? $ad['mediaShow']['word'] : '耀盛中国Fintech“业务协同” 打造新型“金融独角兽'); ?>">
            <img src="<?php echo e(!empty($ad['mediaShow']['purl']) ? $ad['mediaShow']['purl'] : assetUrlByCdn('/static/images/pc4/v4-media-cover.jpg')); ?>" width="282" height="218">
        </a>
