<?php $__env->startSection('title', '管理团队'); ?>
  ...
  <div class="v4-wrap-team2">
    <div class="v4-team2-main">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img1.jpg')); ?>">
      </div>
    ...
    <div class="v4-team2-main v4-team2-second">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img2.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>王春乾</h3>
        <h4>九斗鱼 COO</h4>
    ...
    <div class="v4-team2-main">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img3.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>王懿</h3>
        <h4>九斗鱼 CTO</h4>
    ...
    <div class="v4-team2-main v4-team2-second">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img4.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>孔令珍</h3>
        <h4>九斗鱼 CFO</h4>
    ...
    <div class="v4-team2-main">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img5.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>肖可</h3>
        <h4>九斗鱼 风控总监</h4>
    ...
    <div class="v4-team2-main  v4-team2-second">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img6.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>李毅凤</h3>
        <h4>九斗鱼 法务总监</h4>
    ...
    <div class="v4-team2-main">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img7.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>原旭霖</h3>
        <h4>耀盛中国 总裁</h4>
    ...
    <div class="v4-team2-main  v4-team2-second">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img8.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>陈贤伟</h3>
        <h4>耀盛亚洲 执行董事</h4>
    ...
    <div class="v4-team2-main">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img9.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>杜国健</h3>
        <h4>耀盛基金 执行董事</h4>
    ...
    <div class="v4-team2-main  v4-team2-second">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img10.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>梁晋华</h3>
        <h4>耀盛基金 联席董事</h4>
    ...
    <div class="v4-team2-main">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img11.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>关文杰</h3>
        <h4>耀盛资本 行政总裁</h4>
    ...
    <div class="v4-team2-main  v4-team2-second">
      <div class="v4-team2-img">
        <img src="<?php echo e(assetUrlByCdn('/static/images/pc4/team2/team2-img12.jpg')); ?>">
      </div>
      <div class="v4-team2-txt">
        <h3>邢紫君</h3>
        <h4>耀盛资本 执行董事</h4>
