<?php $__env->startSection('title', '九斗鱼'); ?>
    ...
    <form action="/pay/submit" method="post" id="rechargeForm">
            ...
            <?php if(!$isBind): ?>
                ...
                <div class="box_alert">
                    <div class="mask"></div>
                    <div class="bomb_box">
                        <span class="close_box"><img src="<?php echo e(assetUrlByCdn('/static/weixin/images/wap2/w-icon-close.png')); ?>"/></span>

                        <div id="m-bank-new-main" class="w-bank">
                            <?php foreach($authBanks as $authBank): ?>
                            <p class="mt15px"><label class="m-bank-label"><input type="radio" name="bank_card_str" data-value="1" data-bank-code="<?php echo e(App\Http\Models\Bank\CardModel::getBankCode($authBank['bank_id'])); ?>" data-cash="<?php echo e($authBank['cash']); ?>" data-validate="bank" value="<?php echo e($authBank['bank_id']); ?>" bname="<?php echo e(App\Http\Models\Bank\CardModel::getBankName($authBank['bank_id'])); ?>" class="paylimit">&nbsp;<img src="<?php echo e(assetUrlByCdn('/static/images/bank-img/'.$authBank['bank_id'].'.gif')); ?> class="bank-img2"></label></p>
            ...
            <?php else: ?>
                <span id="maxCash" data-cash="<?php echo e($authCard['limit']['cash']); ?>"></span>
                <span id="minCash" data-value="<?php echo e($withholding_recharge_min_money); ?>"></span>
                <section class="wap2-input-group w-q-mt">
                    <div class="wap2-input-box2 bbd3">
                            <span style="display: none"><input type="radio"  checked="checked" name="bank_card_str" bname="<?php echo e($authCard['info']['bank_name']); ?>" value="<?php echo e($authCard['info']['bank_id']); ?>" /></span>
                            <p class="fr">
                                 <span>
                                    <?php echo e($authCard['info']['bank_name']); ?>

                                    <span class="bank-num-4">(****&nbsp;<?php echo e(substr($authCard['info']['card_no'],-4,4)); ?>)</span>
                                 </span>
                            </p>
                        <p>储蓄卡</p>
                    </div>
                ...
                <section>
                    <dl class="wap2-dl">
                        <dt></dt>
                        <dd class="color8c" id="rechargeMsg"><?php echo e($withholding_recharge_min_money); ?>元起充,单笔充值限额<?php echo e($authCard['limit']['cash']); ?>元</dd>
                    </dl>
                </section>
            <?php endif; ?>
            <input type="hidden" name="payType" value="2">
            <section class="wap2-tip error">
                <p id="msgtip"><?php if(Session::has('errors')): ?> <?php echo e(Session::get('errors')); ?> <?php endif; ?></p>
            </section>
...
-->
    ...
    <!-- 输入交易密码碳层 -->
    <?php if(isset($_COOKIE['failOrder'])): ?>
...
<?php $__env->startSection('jsScript'); ?>
    ...
    <script type="text/javascript">
        ...
        (function ($) {
            ...
            if(isNaN(minCash)){
                $("#rechargeMsg").html("<?php echo e($withholding_recharge_min_money); ?>元起充");
            }
            ...
            $(document).ready(function () {
                ...
                currentRechargeMethod = <?php echo e($isBind?1:0); ?>;   //默认没有选择银行卡
                ...
                $('#rechargeForm').submit(function () {
                    ...
                    if (!$(this).data("canSubmit")) {
                        ...
                        //最低
                        withholdingMinCash = <?php echo e($withholding_recharge_min_money); ?>;
                        //bankId
        ...
        {
            if( cash < <?php echo e($withholding_recharge_min_money); ?> ||!card_str || !cash)
            {
                return false;
            }
            $.ajax({
