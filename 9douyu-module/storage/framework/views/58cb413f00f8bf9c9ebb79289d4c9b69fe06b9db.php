...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(assetUrlByCdn('/static/css/pc2.css')); ?>" type="text/css" />
        <link rel="stylesheet" href="<?php echo e(assetUrlByCdn('/static/css/pc4.css')); ?>" type="text/css" />
        <?php /*<link rel="stylesheet" href="<?php echo e(assetUrlByCdn('/static/theme/spring/css/theme.css')); ?>" />*/ ?>
...
<script type="text/javascript" src="<?php echo e(assetUrlByCdn('static/js/jquery-1.9.1.min.js')); ?>"></script>
    ...
    <?php $__env->startSection('header'); ?>
        <?php echo $__env->make('pc4.common/header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->yieldSection(); ?>

    <?php echo $__env->yieldContent('content'); ?>
    
    <?php $__env->startSection('footer'); ?>
        <?php echo $__env->make('pc4.common/footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->yieldSection(); ?>
 

    <?php echo $__env->make('pc4.common/qqService', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
