...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(assetUrlByCdn('images/admin/favicon.png')); ?>" type="image/png">
    ...
    <?php $__env->startSection('css'); ?>
        ...
        <!--[if lt IE 9]>
        <script src="<?php echo e(assetUrlByCdn('js/admin/html5shiv.js')); ?>"></script>
        <script src="<?php echo e(assetUrlByCdn('js/admin/respond.min.js')); ?>"></script>
        <![endif]-->
</head>
                    ...
                    <li>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                                ...
                                <li><a href="<?php echo e(url('admin/logout')); ?>"><i class="glyphicon glyphicon-log-out"></i> 退出</a></li>
                                <li><a href="<?php echo e(url('/')); ?>" target="_blank"><i class="glyphicon glyphicon-log-out"></i>前台首页</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
...
<?php $__env->startSection('javascript'); ?>
    <script src="<?php echo e(assetUrlByCdn('js/admin/jquery-1.10.2.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(assetUrlByCdn('js/admin/dashboard.js')); ?>"></script>
