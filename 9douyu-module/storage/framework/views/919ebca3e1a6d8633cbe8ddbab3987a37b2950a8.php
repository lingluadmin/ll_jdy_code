...
<?php $__env->startSection('title', '电子账户-手机号修改'); ?>

<?php $__env->startSection('content'); ?>
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <div class="t-wrap t-mt30px">
        <div class="t-account1">
            <h3 class="t-accout-title"><span></span>电子账户-手机号修改</h3>
            <form method="post" action="" id="findPasswordForm">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                <dl class="t-accout-2">
                    <dt class="t-lh36px">手机号</dt>
                    <dd><input type="text"  name="phone" id="phone" autocomplete="off" placeholder="手机号码" class="form-input t-a-1" value="<?php echo e($phone); ?>" disabled/></dd>
                </dl>
                <dl class="t-accout-2">
                    <dt class="t-lh36px">新手机号</dt>
                    <dd><input type="text"  name="mobile" id="mobile" autocomplete="off" placeholder="请输入新手机号码" class="form-input t-a-1" /></dd>
                </dl>
                <dl class="t-accout-2">
