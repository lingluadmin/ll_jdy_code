<?php $__env->startSection('title', '添加提现银行卡'); ?>
    ...
    <div class="m-myuser">
        ...
        <div class="m-rightcon m-pr">
            ...
            <div class="m-process m-pr">
                ...
                <p class="m-cardtips">温馨提醒：下述银行卡号的开户人姓名必须为"<strong><?php echo e($userInfo['real_name']); ?></strong>"，银行卡号必须填写正确,否则会导致添提现银行卡失败。 </p>
            ...
            <form method="post" action="/user/bankcard/submit" id="addBankCardForm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td>姓名</td>
                        <td><?php echo e($userInfo['real_name']); ?></td> <input type="hidden" name="real_name" value="<?php echo e($userInfo['real_name']); ?>"/> <input type="hidden" name="user_id" value="<?php echo e($userInfo['id']); ?>"/>
                    </tr>
                    <tr>
                        <td>身份证号</td>
                        <td><?php echo e(substr($userInfo['identity_card'],0,4)); ?>********<?php echo e(substr($userInfo['identity_card'],-4)); ?></td><input type="hidden" name="id_card" value="<?php echo e($userInfo['identity_card']); ?>"/>
                    </tr>
                    <tr>
                        <td>银行卡号</td>
