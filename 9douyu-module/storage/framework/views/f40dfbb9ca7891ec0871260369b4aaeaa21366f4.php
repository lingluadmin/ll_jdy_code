<?php $__env->startSection('title','我要提现-九斗鱼,心安而有余'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="m-myuser">
        ...
        <div class="m-rightcon">
            ...
            <p class="m-tips">
                提示：每位用户每自然月有<?php echo e($maxFreeNum); ?>次免费提现机会，超过<?php echo e($maxFreeNum); ?>次以后的每笔提现将收<?php echo e($handlingFree); ?>元手续费，请知晓。
            </p>
            <span id="withdrawFeeRate" data-value="<?php echo e(env('WITHDRAW_FEE_RATE')); ?>"></span>
            <span id="minMoney" data-value="<?php echo e($minMoney); ?>"></span>
            <span id="freeAmount" data-value="<?php echo e($userInfo['balance']); ?>"></span>
            <span id="needHandling" data-value="<?php echo e($commission); ?>"></span>
            <span id="withDrawNum" data-value="<?php echo e($withDrawNum['total']); ?>"></span>
            <span id="withDrawFreeNum" data-value="<?php echo e($maxFreeNum); ?>"></span>
            <?php if($withdrawCard): ?>
                <form  action="<?php echo e(URL('/pay/withdraw/submit')); ?>" method="post">
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td class="m-firsttd">姓名</td>
                            <td><?php echo e($userInfo['real_name']); ?></td><input name="real_name" type="hidden" value="<?php echo e($userInfo['real_name']); ?>" class="form-control" readonly>
                        </tr>
                        <tr>
                            <td class="m-firsttd">选择银行卡</td>
                            <td class="m-pr">
                                <div class="m-mselect m-pr">
                                    <span class="m-mselectshow"><?php echo e(substr($withdrawCard[0]['card_no'],0,4)); ?>****<?php echo e(substr($withdrawCard[0]['card_no'],-4)); ?> <?php echo e(App\Http\Models\Bank\CardModel::getBankName($withdrawCard[0]['bank_id'])); ?></span><i class="m-btnselect"  ></i>
                                    <ul class="m-mlist" id="bank_card_id">
                                        <?php foreach($withdrawCard as $card): ?>
                                            <li data-target="<?php echo e($card['card_no']); ?>" data-target1="<?php echo e($card['bank_id']); ?>"><?php echo e(substr($card['card_no'],0,4)); ?>****<?php echo e(substr($card['card_no'],-4)); ?> <?php echo e(App\Http\Models\Bank\CardModel::getBankName($card['bank_id'])); ?></li>
                                        <?php endforeach; ?>
                                    </ul><p id="bank_card_id_msg"></p>
                                    <input type="hidden" name="card_no" value="<?php echo e($withdrawCard[0]['card_no']); ?>">
                                    <input type="hidden" name="bank_id" value="<?php echo e($withdrawCard[0]['bank_id']); ?>">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="m-firsttd">当前可用余额</td>
                            <td  id="balance" value="<?php echo e($userInfo['balance']); ?>"><?php echo e($userInfo['balance']); ?>元</td>
                            <input name="balance" type="hidden" value="<?php echo e($userInfo['balance']); ?>" class="form-control" readonly>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td id="cash_rate"><?php echo e($commission); ?>元</td>
                            <input name="commission" type="hidden" value="<?php echo e($commission); ?>" class="form-control" readonly>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="m-pr">
                                ...
                                <?php if( (Session::get('errors') == \App\Lang\LangModel::getLang('ERROR_USER_PASSWORD_CHECKED')) && Session::has('errors') ): ?> <a href="/user/setting/tradingPassword">设置交易密码</a> <?php endif; ?>
                ...
                <div class="layer_wrap js-mask" data-modul="modul1">
                    ...
                    <div class="Js_layer layer">
                        ...
                        <dl class="t-alert-know">
                            <dt>1.</dt>
                            <dd> 每位用户每自然月有<?php echo e($maxFreeNum); ?>次免费提现机会，超过<?php echo e($maxFreeNum); ?>次以后的每笔提现将收<?php echo e($handlingFree); ?>元手续费：</dd>
                            <dt>2.</dt>
                            <dd>单笔提现金额<?php echo e($minMoney); ?>元起</dd>
                            <dt>3.</dt>
...
<?php $__env->startSection('jspage'); ?>
    <script type="text/javascript" src="<?php echo e(assetUrlByCdn('/static/js/jquery.plugin.js')); ?>"></script>
