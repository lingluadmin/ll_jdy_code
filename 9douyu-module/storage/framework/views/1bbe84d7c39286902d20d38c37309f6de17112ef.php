<div class="v4-wrap-margin clearfix" ms-if="@counter.len3 > 0">
    <div class="v4-project-more more5">
        <h3>综合项目</h3>
        <p>卓越价值&nbsp;多元选择</p>
        <a href="/project/index" class="v4-btn v4-btn-more">更多项目</a>
    </div>

    <div class="v4-project-box" ms-for="(k,v) in @project.multiProjectList" ms-click="@redirectDetail(@v.id)">
