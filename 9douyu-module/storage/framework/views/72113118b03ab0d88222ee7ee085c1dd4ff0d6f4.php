<?php $__env->startSection('title','账户总览'); ?>
<?php $__env->startSection('csspage'); ?>
<link rel="stylesheet" type="text/css" href="<?php echo e(assetUrlByCdn('/assets/css/pc4/tip-yellow.css')); ?>">
...
<div class="v4-account auto">
        ...
        <div class="v4-account1 hidden">
            <dl class="v4-account-1">
                ...
                <dd>
                    <h5 class="js-poshytip">
                        <em> Hi,<?php echo e($user_info['phone']); ?> </em>
                        ...
                        <?php endif; ?>
                         ...
                         <?php if($user_info['password_hash'] == $user_info['trading_password'] || empty($user_info['trading_password'])): ?>
                        ...
                        <?php if(!empty($user_info['assessment_type'])): ?>
                    ...
                    <p class="v4-account-risk-1">风险等级
                        <?php if(!empty($user_info['assessment_type'])): ?>
                            <span class="orange"><?php echo e($user_info['assessment_type']); ?></span>
            ...
            <div class="v4-account-2">
                <?php if( !empty($user_bank) ): ?>
                    ...
                    <dd>银行卡号<span><?php echo e($user_bank['card_number']); ?></span></dd>
                <?php else: ?>
        ...
        <div class="v4-account2">
            <h2 class="v4-account-titlex">资产总览</h2>
                ...
                <dl class="v4-account2-1">
                    ...
                    <dd>
                        <p>预期总资产(元)</p>
                        <h5><?php echo e(number_format($user_info['total_amount'],2)); ?></h5>
                    </dd>
                </dl>
                ...
                <dl class="v4-account2-2">
                    <dt>
                        <p>可用余额(元)</p>
                        <h5><?php echo e(number_format($user_info['balance'],2)); ?></h5>
                    </dt>
                    <dd>
         ...
         <div class="v4-account3">
            ...
            <div class="v4-account3-2">
                <p><i class="icon1"></i>可用余额(元) <span><?php echo e(number_format($user_info['balance'],2)); ?></span></p>
                <p><i class="icon2"></i>待收收益(元) <span><?php echo e(number_format($project_account['total_amount_interest'],2)); ?></span></p>
                <p><i class="icon3"></i>在投本金(元) <span><?php echo e(number_format($project_account['total_amount_principal']+$current_account['cash'],2)); ?></span></p>
            </div>
        </div>
                ...
                <ul class="v4-asset-distribution">
                    <li>
                        ...
                        <span class="v4-w184px">
                            <ins><?php echo e(number_format($current_account['cash'],2)); ?></ins><br/>持有金额(元)
                        </span>
                        <span class="v4-w184px">
                            <ins><?php echo e(number_format($current_account['yesterday_interest'],2)); ?></ins><br/>昨日收益(元)
                        </span>
                        <span class="v4-w184px">
                            <ins><?php echo e(number_format($current_account['interest'],2)); ?></ins><br/>累计收益(元)
                        </span>
                    ...
                    <li>
                        ...
                        <span class="v4-w184px">
                            <ins><?php echo e(number_format($project_account['total_amount_principal'],2)); ?></ins><br/>在投本金(元)
                        </span>
                        <span class="v4-w184px">
                            <ins><?php echo e(number_format($project_account['total_amount_interest'],2)); ?></ins><br/>待收收益(元)
                        </span>
                        <span class="v4-w184px">
                            <ins><?php echo e(number_format($project_account['refund_interest'],2)); ?></ins><br/>累计收益(元)
                        </span>
                        <span class="v4-w196px">
                    ...
                    <li>
                        ...
                        <span class="v4-w184px">
                            <ins><?php echo e(number_format($smart_account['total_principal'],2)); ?></ins><br/>在投本金(元)
                        </span>
                        <span class="v4-w184px">
                            <ins><?php echo e(number_format($smart_account['due_interest'],2)); ?></ins><br/>待收收益(元)
                        </span>
                        <span class="v4-w184px">
                            <ins><?php echo e(number_format($smart_account['total_interest'],2)); ?></ins><br/>累计收益(元)
                        </span>
                        <span class="v4-w196px">
 ...
 <!-- 零钱计划转出确认 -->
    <div class="v4-layer_wrap js-mask" data-modul="modul0"  style="display:none;" id="currentOut">
        ...
        <div class="v4-layer_title red">零钱计划转出确认<a href="javascript:;" class="v4-layer_close Js_layer_close" data-toggle="mask" data-target="js-mask" ></a></div>     
                   <dl class="v4-input-group v4-turn">
                       ...
                       <dd>
                           <p><?php echo e(number_format($current_account['cash'],2)); ?></p>
                       </dd>
                       <dt> 
                      ...
                      <dt>
                       ...
                       <dd>
                           ...
                           <?php /*<input value="" type="password" name="password" placeholder="请输入6~16位字母和数字的组合" id="password" data-pattern="password" class="v4-input">*/ ?>
                           <span class="v4-input-status"><i class="t1-icon v4-iconfont"></i></span>
                       ...
                       <dd>
                           ...
                           <input type="hidden" name="balance" value="<?php echo e($current_account['cash']); ?>">
    ...
    <!-- 风险提示书 -->
    <div id="lay_wrap3"  class="v4-layer_wrap js-mask" data-modul="modul3"  <?php if($user_info['assessment']==1): ?> style="display:block;" <?php else: ?> style="display:none;" <?php endif; ?>>
...
<script src="<?php echo e(assetUrlByCdn('/assets/js/pc4/echarts.common.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(assetUrlByCdn('/assets/js/pc4/jquery.poshytip.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(assetUrlByCdn('/assets/js/pc4/custodyAccount.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(assetUrlByCdn('/assets/js/pc4/layer.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(assetUrlByCdn('/assets/js/pc4/toFixed.js')); ?>" type="text/javascript"></script>
...
<script type="text/javascript">
            ...
            series: [
                {
                    ...
                    data:[
                        {value:'<?php echo e($user_info['balance']); ?>', name:'可用余额'},
                        {value:'<?php echo e($project_account['total_amount_interest']); ?>', name:'待收收益'},
                        {value:'<?php echo e($project_account['total_amount_principal']+$current_account['cash']); ?>', name:'在投本金'}
    ...
    var assessment=<?php echo e($user_info['assessment']); ?>;
    if(assessment==1){
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
