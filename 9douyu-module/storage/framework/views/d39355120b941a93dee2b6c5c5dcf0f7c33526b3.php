...
<?php $__env->startSection('content'); ?>
   <div class="v4-account">
        <?php echo $__env->make('pc.article.helpnav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
       <?php echo $current['content']; ?>

        <?php /*<div class="v4-content v4-account-white">
            <h2 class="v4-account-titlex v4-help-title"><?php echo e($current['title']); ?></h2>
...
<script type="text/javascript" src="<?php echo e(assetUrlByCdn('/assets/js/pc4/toggleContent.js')); ?>"></script>
