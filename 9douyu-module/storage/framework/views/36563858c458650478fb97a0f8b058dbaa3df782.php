            ...
            <form action="/recharge/submit" method="post" id="rechargeForm">
                ...
                <div class="t-recharge6">
                    ...
                    <ul class="recharge-method t-recharge-nav">
                        ...
                        <?php if(!empty($authBanks)): ?>
                            <li data-type="2">快捷支付<span></span></li>
                        <?php else: ?>
                            <li data-type="2" class="recharge-width-nav">快捷支付<em></em><img src="<?php echo e(assetUrlByCdn('/static/images/bank-img/'.$authCard['info']['bank_id'].'.png')); ?>" width="25" alt="" /><b><?php echo e($authCard['info']['bank_name']); ?> **** <?php echo e(substr($authCard['info']['card_no'],-4)); ?></b><span></span></li>
                        <?php endif; ?>
                    </ul>
                </div>
                <div class="clear"></div>
                        ...
                        <div class="t-recharge-bank">
                            <ul class="recharge-bank hidden t-recharge-bank1" data-type="1">
                                <?php foreach($unionPay as $union): ?>
                                    <li bvalue="<?php echo e($union['bank_id']); ?>" data-alias="<?php echo e($union['alias']); ?>" ><img src="<?php echo e(assetUrlByCdn('/static/images/bank-img/'.$union['bank_id'].'.gif')); ?>" width="136" height="50" /><span></span></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                ...
                <div class="recharge-bank-box t-recharge10 hidden" style="display:none">
                    ...
                    <div class="t-recharge9">
                        ...
                        <?php /*<p class="t-recharge6-1 t-recharge6-2">选择银行</p>*/ ?>
                        <?php /*<div class="t-recharge-bank">*/ ?>
                            <?php /*<?php if(!empty($authBanks)): ?>*/ ?>
                                <?php /*<ul class="recharge-bank hidden t-recharge-bank1" data-type="2">*/ ?>
                                    <?php /*<?php foreach($authBanks as $authBank): ?>*/ ?>
                                        <?php /*<li bvalue="<?php echo e($authBank['bank_id']); ?>" data-cash="<?php echo e($authBank['cash']); ?>"><img src="<?php echo e(URL::asset('/')); ?>static/images/bank-img/<?php echo e($authBank['bank_id']); ?>.gif" width="136" height="50"/><span></span></li>*/ ?>
                                    <?php /*<?php endforeach; ?>*/ ?>
                                <?php /*</ul>*/ ?>
                            <?php /*<?php else: ?>*/ ?>
                                <?php /*<span id="bindBankUser"></span>*/ ?>
                                <?php /*<span id="maxCash" data-value="<?php echo e($authCard['limit']['cash']); ?>"></span>*/ ?>
                                <?php /*<ul class="recharge-bank hidden t-recharge-bank1" data-type="2">*/ ?>
                                    <?php /*<li class="t-selected t-recharge-num" data-value="<?php echo e($authCard['info']['bank_id']); ?>" bvalue="<?php echo e($authCard['info']['bank_id']); ?>" data-cash="<?php echo e($authCard['limit']['cash']); ?>"><img src="<?php echo e(URL::asset('/')); ?>static/images/bank-img/<?php echo e($authCard['info']['bank_id']); ?>.gif" width="136" height="50" class="fl" /><i>尾号<em><?php echo e(substr($authCard['info']['card_no'],-4,4)); ?></em></i><span class="t-icon"></span></li>*/ ?>
                                <?php /*</ul>*/ ?>
                                <?php /*<input type="hidden" name="card_no" value="<?php echo e($authCard['info']['card_no']); ?>">*/ ?>
                            <?php /*<?php endif; ?>*/ ?>
                        <?php /*</div>*/ ?>
                        ...
                        <?php if(!empty($authBanks)): ?>
                            ...
                            <div class="t-recharge-bank">
                                <ul class="recharge-bank hidden t-recharge-bank1" data-type="2">
                                    <?php foreach($authBanks as $authBank): ?>
                                        <li bvalue="<?php echo e($authBank['bank_id']); ?>" data-cash="<?php echo e($authBank['cash']); ?>"><img src="<?php echo e(assetUrlByCdn('/static/images/bank-img/'.$authBank['bank_id'].'.gif')); ?>"  width="136" height="50"/><span></span></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        ...
                        <?php else: ?>
                            <span id="maxCash" data-value="<?php echo e($authCard['limit']['cash']); ?>"></span>
                            <p class="t-recharge6-1 t-recharge6-2">支付渠道</p>
                            <div class="recharge-channel-wrap clearfix">
                                <?php foreach($authCard['list'] as $val): ?>
                                    <ul class="recharge-channel t-selected" bvalue="<?php echo e($val['pay_type']); ?>" data-cash="<?php echo e($val['real_limit']); ?>">
                                        <li class="recharge-channel-bt"><img src="<?php echo e(assetUrlByCdn('/static/images/bank-img/'.$val['pay_type'].'.png')); ?>"  width="72" alt="<?php echo e($typeList[$val['pay_type']]['name']); ?>"><?php echo e($typeList[$val['pay_type']]['name']); ?><span></span></li>
                                        <li class="recharge-channel-txt clearfix"><span class="fl">单笔限额</span><em class="fr"><?php echo e($val['limit']); ?>元</em></li>
                                        <li class="recharge-channel-txt clearfix"><span class="fl">当日限额剩余</span><em class="fr"><?php echo e($val['day_free_limit']); ?>元</em></li>
                                    </ul>
                                <?php endforeach; ?>
                            </div>
    ...
    <div class="layer_wrap js-mask" data-modul="modul1">
        ...
        <div class="Js_layer layer">
             ...
             <dl class="t-alert-know">
                ...
                <dt>2.</dt>
                <dd>单笔充值金额<?php echo e($recharge_min_money); ?>元起，每日的充值限额依据各银行限额为准；</dd>
                <dt>3.</dt>
                <dd>严禁利用充值功能进行信用卡套现、转账、洗钱等行为，一经发现，资金将退回原卡并封停账号<?php echo e($withdrawConfig['closeAccountDays']); ?>天；</dd>
                <dt>4.</dt>
                <dd>账户资金每自然月有<?php echo e($withdrawConfig['maxFreeNum']); ?>次免费提现机会，超过<?php echo e($withdrawConfig['maxFreeNum']); ?>次以后的每笔提现将收<?php echo e($withdrawConfig['handingFree']); ?>元手续费。</dd>
                <dt>5.</dt>
...
<script>
        (function($){
            $(document).ready(function(){
                ...
                if(data_type==1){
                    $(".t-recharge4").html("<span></span>温馨提示：<?php echo e($withholding_recharge_min_money); ?>元起充,单笔充值限额视开户行定");
                }else if(maxCash>0){
                    $(".t-recharge4").html("<span></span>温馨提示：<?php echo e($withholding_recharge_min_money); ?>元起充,单笔充值限额"+maxCash+"元");
                }else{
                    $(".t-recharge4").html("<span></span>温馨提示：<?php echo e($withholding_recharge_min_money); ?>元起充");
                }
                ...
                $("#rechargeForm").submit(function() {
                    ...
                    if(!$(this).data("canSubmit")) {
                        ...
                        var flag = true;
                        var minCash = <?php echo e($withholding_recharge_min_money); ?>;
                        var withholdingMinCash = <?php echo e($withholding_recharge_min_money); ?>;
                        ...
                        if(currentRechargeMethod != 1 && cash < withholdingMinCash){
                            $("#cash-tips").addClass("t-recharge-tip").show().html("绑定银行卡充值单笔最小充值金额为<?php echo e($withholding_recharge_min_money); ?>元");
                            return false;
                ...
                $(".recharge-method li").click(function(){
                    ...
                    if($(this).index()==0){
                        ...
                        $("#t-recharge-method-txt").html("<span></span>仅支持绑定开户名为<?php echo e($user['real_name']); ?>的借记卡（无需开通网银），且单笔最小充值金额为<?php echo e($withholding_recharge_min_money); ?>元。");
                        if(maxCash>0)
                            $(".t-recharge4").html("<span></span>温馨提示：<?php echo e($withholding_recharge_min_money); ?>元起充,单笔充值限额"+maxCash+"元");
                        else
                            $(".t-recharge4").html("<span></span>温馨提示：<?php echo e($withholding_recharge_min_money); ?>元起充");
