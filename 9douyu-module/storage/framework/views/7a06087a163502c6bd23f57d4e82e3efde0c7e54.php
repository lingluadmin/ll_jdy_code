    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <div class="signin-info">
                ...
                <br />
                <br />
                <img src="<?php echo e(assetUrlByCdn('/static/images/new/logo-new-replace.png')); ?>" width="445px"/>
        ...
        <div class="col-md-5">
            <form method="post" action="/admin/login">
                ...
                <?php endif; ?>
                    ...
                    <input type="hidden" name="sign" value="<?php echo e(env('LOGIN_SIGN')); ?>"/>
                    <?php /*<input type="text" name="captcha" class="form-control" placeholder="验证码"/>
