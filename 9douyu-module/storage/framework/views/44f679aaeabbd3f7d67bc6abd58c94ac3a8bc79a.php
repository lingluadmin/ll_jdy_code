...
<?php $__env->startSection('content'); ?>
    ...
    <article>
        <section class="w-bc hidden">
            ...
            <p class="center w-fff-color mt15px"><span class="font30px"><?php echo e($balance); ?></span><span>元</span></p> 
        </section>

        <section class="w-button-box">
            <table class="w-table w-bc1">
                <tr>
                    <td width="50%" class="br1px"><p class="lh2rem w-ye-pl"><span>累计提现</span></p><p class="w-bule-color w-ye-pl"><span class="font15px"><?php echo e($withdraw); ?> </span>元</p></td>
                    <td><p class="lh2rem w-ye-pl1"><span>累计充值</span></p><p  class="w-bule-color  w-ye-pl1"><span class="font15px "><?php echo e($totalRecharge); ?> </span>元</p></td>
                </tr>
            </table>
        ...
        <section class="w-box-show mt15px pd-tb0px pd-lr0px" id="balance_child">
            <div id="data_list">
                <?php if( empty($LogList['total']) ): ?>
                    <div class="w-dou-pd">
                        <p class="center"><img src="<?php echo e(assetUrlByCdn('/static/weixin/images/wap2/w-logo.png')); ?>" class="no-img"></p>
                        <p class="w-zw">暂无记录</p>
                    </div>
                <?php endif; ?>
                <?php echo $__env->make('wap.user.AccountBalance._balance_child', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
            <?php if( isset($LogList['total']) && $LogList['total'] > $LogList['size'] ): ?>
...
<?php $__env->startSection('jsScript'); ?>
    <?php /*<script type="text/javascript" src="<?php echo e(App\Tools\ToolCdnStatic::statics('/static/js/jquery-1.9.1.min.js')); ?>"></script>*/ ?>
    <script type="text/javascript">
        ...
        (function ($) {
            $(document).ready(function () {
                var noHtml = '<div class="w-dou-pd" id="zwjl"><p class="center "><img src="<?php echo e(assetUrlByCdn('/static/weixin/images/wap2/w-logo.png')); ?>" class="no-img"></p><p class="w-zw">暂无记录</p></div>';
                //get data
