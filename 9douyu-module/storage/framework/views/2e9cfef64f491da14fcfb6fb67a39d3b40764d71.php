                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xxlarge focused not_null" type="text" name="name" required="required" value="<?php echo e(Input::old('name')); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xxlarge focused not_null" type="text" name="key" required="required" value="<?php echo e(Input::old('key')); ?>"><span class = "add-on " id="appendConfigButton">添加二级配置</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group value_area">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input type="text" class="input-xxlarge value_area not_null" name="value" value="<?php echo e(Input::old('value')); ?>">
                                </div>
                            </div>
                        </div>
