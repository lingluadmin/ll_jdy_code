                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge " id="focupsedInput" type="text" name="base_rate" value="<?php echo e(Input::old('base_rate')); ?>"><span class="add-on"> + </span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused" id="date02" type="text" name="invest_time" value="<?php echo e(Input::old('invest_time')); ?>"><span class="add-on invest_time_note"> 天 </span>
                                </div>
                            </div>
                        </div>
                        <?php /*到期日期*/ ?>
                        ...
                        <?php /*<div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <?php foreach( $activity_sign as $key => $value ): ?>
                                    <label><input class="input-xlarge focused"  type="radio" name="newcomer" value="<?php echo e($key); ?>"><?php echo e($value); ?></label>
                                    <?php endforeach; ?>
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content">
                    <table class="table table-striped table-bordered bootstrap-datatable">
                        ...
                        <?php if(is_array($creditList) && !empty($creditList)): ?>
                            <?php foreach($creditList as $key => $info): ?>
                                <tr>
                                    <input type="hidden" name="credit[<?php echo e($info['id']); ?>][type]" value="100" />
                                    <input type="hidden" name="credit[<?php echo e($info['id']); ?>][cash]" value="<?php echo e($info['loan_amounts']); ?>" />
                                    <td>
                                        <label><input type="radio" class="input-xlarge focused" name="credit_id" value="<?php echo e($info['id']); ?>"></label>
                                    </td>
                    ...
                    <?php /*<table class="table table-striped table-bordered bootstrap-datatable">
                        <thead>
                        <tr>
                            <th></th>
                            <th>序号</th>
                            ...
                            <?php if(is_array($creditList) && !empty($creditList)): ?>
                                <?php foreach($creditList as $key => $info): ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($info['id']); ?></td>
                                        <td><?php echo e($info['credit_name']); ?></td>
                                        <td><?php echo e($info['loan_username']); ?></td>
                                        <td><?php echo e($info['loan_amounts']); ?></td>
                                        <td><?php echo e($info['interest_rate']); ?>%</td>
                                        <td><?php echo e($refundType[$info['repayment_method']]); ?></td>
                                        <td><?php echo e($info['loan_deadline']); ?>
                                        ...
                                        <td><?php echo e($info['loan_days']); ?>天</td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </tbody>
