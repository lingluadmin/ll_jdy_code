<div class="v4-footer-bottom">
    <div class="v4-wrap hidden">
        <div class="v4-footer-copyright">
            <p>星果时代信息技术有限公司版权所有&nbsp;&nbsp;京ICP备16011752号-1&nbsp;&nbsp;<a href="http://www.beian.gov.cn/portal/registerSystemInfo" rel='nofollow' target="_blank"><img src="<?php echo e(assetUrlByCdn('/static/images/pc4/v4-installation.png')); ?>" width="20" height="20"> 京公网安备 11010502033496号</a></p>
