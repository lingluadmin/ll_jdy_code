<?php $__env->startSection('title','赎回申请'); ?>
  ...
  <h2 class="v4-account-titlex">赎回申请</h2>
    <div class="v4-confirm-1">
      ...
      <table class="v4-confirm-table">
        ...
        <tbody>
          <tr>
            <td class="pl60px" width="284"><a href="/project/detail/<?php echo e($project['id']); ?>"><?php echo e($project['name']); ?>&nbsp;&nbsp;<?php echo e($project['format_name']); ?></a></td>
            <td><?php echo e((float)$project['base_rate']); ?>% <?php if($project['after_rate']>0): ?> +<?php echo e((float)$project['after_rate']); ?>%<?php endif; ?></td>
            <td><?php echo e($project['format_invest_time'] . $project['invest_time_unit']); ?></td>
            <td><?php echo e($lock_days); ?>天</td>
            <td><?php echo e($project['refund_type_note']); ?></td>
            <td>提前赎回</td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="v4-confirm-2">
      <div class="v4-confirm-content">
        <dl class="v4-input-group">
          <dt>到账金额(元)</dt>
          <dd><p><span class="v4-confirm-red"><?php echo e(number_format($refund_cash,2)); ?></span></p></dd>
        </dl>

        <div class="v4-apply-detail">
          <ul>
            <li>
              <p><span>赎回本金(元)</span><?php echo e(number_format($cash,2)); ?></p>
            </li>
            <li>
              <p><span>已赚收益(元)</span><?php echo e(number_format($interest,2)); ?></p>
            </li>
            <li>
              <p><span>赎回手续费(元)</span><?php echo e(number_format($fee,2)); ?></p>
            </li>
          </ul>
        </div>
        ...
        <dl class="v4-input-group">
          ...
          <dd>
              <?php /*<input type="password" name="trade_password" placeholder="请输入6~16位字母和数字的组合" data-pattern="password" class="v4-input">*/ ?>
            <input type="password" name="password" placeholder="请输入6~16位字母和数字的组合"  data-pattern="password" class="v4-input" ms-duplex="@trade_password" ms-focus="cleanMsg('tradePw')">
              <input type="hidden" name="invest_id" value="<?php echo e($investId); ?>" />
              <input type="hidden" name="project_id" value="<?php echo e($project['id']); ?>" />
              <input type="hidden" name="cash" value="<?php echo e($cash); ?>" />
              <input type="hidden" name="fee" value="<?php echo e($fee); ?>" />
          ...
          <dd>
            ...
            <div class="v4-input-agree">
              <label><input type="checkbox" checked="checked" ms-duplex-checked="@isCheck" ms-click="cleanMsg('agree')">我已阅读并同意<a href="<?php echo e(assetUrlByCdn('/static/pdf/InvestmentAndManagement.pdf')); ?>" class="blue" target="_blank">《出借咨询与管理服务协议》</a></label>
            </div>
          </dd>
        </dl>
      </div>
...
<script type="text/javascript" src="<?php echo e(assetUrlByCdn('/static/lib/biz/apply-refund.js')); ?>"></script>
