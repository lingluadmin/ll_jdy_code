    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    {
        return PasswordModel::validatePassword($password, $user['password']);
//        return $user['password'] == sha1($password);
    }

    public function getUser($username)
    {
        $userInfo = UserLoginModel::getCoreApiBaseUserInfo($username);
    ...
    {
//        $UserDb   = new UserDb();
//        $password = $UserDb->encryptionPassword($password);
