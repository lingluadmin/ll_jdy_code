 ...
 * Time: 下午15:23
 */
namespace App\Services\Pay\Withholding\Rea;
$basePath = base_path();
require_once($basePath."/app/Services/Pay/Withholding/Rea/api/util.class.php");
...
class Reapay {
    ...
    public function __construct($config)
    {
        ...
        $this->payPublicKey = $this->basePath.'/app/Services/Pay/Withholding/Rea/cert/public.pem';
        $this->payPrivateKey = $this->basePath.'/app/Services/Pay/Withholding/Rea/cert/private.pem';

        $this->checkCardPublicKey = $this->basePath.'/app/Services/Pay/Withholding/Rea/check/public.pem';
        $this->checkCardPrivateKey = $this->basePath.'/app/Services/Pay/Withholding/Rea/check/private.pem';
